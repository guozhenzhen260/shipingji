...
#define UART0_IRQ_HANDLER               UART0_StdIntHandler             /* 21 UART0                     */
#define UART1_IRQ_HANDLER               Uart1_IRQHandler             /* 22 UART1                     */
#define UART2_IRQ_HANDLER               Uart2_IRQHandler             /* 23 UART2                     */
...
#define EINT2_IRQ_HANDLER               EINT2_IRQHandler           		/* 36 EINT2                     */
