...
#define PARAM_I2S_DATA(data) 	(data <= 0xFFFFFFFF)//120331 by cq disable warning
...
#define PARAM_I2S_WS_SEL(n)		((n==I2S_MASTER_MODE)||(n==I2S_SLAVE_MODE))//120331 by cq disable warning
...
#define PARAM_I2S_DMA_DEPTH(n)	(n<=31)//120331 by cq disable warning
//#define PARAM_I2S_IRQ_LEVEL(n)	((n>=0)||(n<=31))
#define PARAM_I2S_IRQ_LEVEL(n)	(n<=31)//120331 by cq disable warning
