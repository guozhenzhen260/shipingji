...
#include  "..\cfg_file\Startup\vector_cfg.h"

#include "..\ZY_CODE\Startup\LPC1700.h"


#include "..\ZY_CODE\uCOS-II\cpu\os_cpu.h"//120331 by cq disable warning
#include "..\ZY_CODE\zy_if\zy_if.h"//120331 by cq disable warning
...
UartDev_IOB UART_DEV = {
                     {9600, UartDev_DATABITS_8, UartDev_STOPBITS_1, UartDev_PARITY_NONE},
                     UartDev_Init,
                     UartDev_UnInit,
                     UartDev_BufTx,
                     UartDev_BufRx,
...
static int UartDev_Init (void) {
 ...
 // zyIsrSet((UARTInfo.UARTIRQn +16), (unsigned long)IRQ_21_HANDLE, ((0x01<<3)|0x01));
  //zyIsrSet((UARTInfo.UARTIRQn +16), (unsigned long)IRQ_22_HANDLE, PRIO_NINE);
...
static void ConfigurePins (void) {
	...
	idx = idx;//120331 by cq disable warning
