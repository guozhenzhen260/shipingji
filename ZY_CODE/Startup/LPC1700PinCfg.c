...
void pinInit (void)
{
     ...
     * 引脚连接配置P0.16 -- P0.30
     */
    zPINSEL1  = (P0_30_FNUC << 28)|(P0_29_FNUC << 26)|(P0_28_FNUC << 24)|(P0_27_FNUC << 22)|
     ...
     * 引脚连接配置P1.0 -- P1.15
     */
    zPINSEL2  = (P1_15_FNUC << 30)|(P1_14_FNUC << 28)|(P1_10_FNUC << 20)|(P1_9_FNUC << 18)|
               (P1_8_FNUC  << 16)|(P1_4_FNUC << 8)  |(P1_1_FNUC << 2)  |(P1_0_FNUC << 0);

    /*
     * 引脚连接配置P1.16 -- P1.31
     */
    zPINSEL3  = (P1_31_FNUC << 30)|(P1_30_FNUC << 28)|(P1_29_FNUC << 26)|(P1_28_FNUC << 24)| 
     ...
     * 引脚连接配置P2.0 -- P2.13
     */       
    zPINSEL4  = (P2_13_FNUC << 26)|(P2_12_FNUC << 24)|(P2_11_FNUC << 22)|(P2_10_FNUC << 20)|
     ...
     * 引脚连接配置P3.25 -- P3.26
     */
    zPINSEL7  = (P3_26_FNUC << 20)|(P3_25_FNUC << 18);

    /*
     * 引脚连接配置P4.28 -- P4.29
     */
    zPINSEL9  = (P4_29_FNUC <<26) | (P4_28_FNUC <<24);

    zPINSEL10 = P10_3_FNUC;                                              /*  禁止ETM接口功能             */
#if 1

    /*
     * 引脚内部上下拉电阻配置
     */
    zPINMODE0 = (P0_15_MODE << 30)|(P0_14_MODE << 28)|(P0_13_MODE << 26)|(P0_12_MODE << 24)|
    ...
    zPINMODE1 = (P0_30_MODE << 28)|(P0_29_MODE << 26)|(P0_28_MODE << 24)|(P0_27_MODE << 22)|
    ...
    zPINMODE2 = (P1_15_MODE << 30)|(P1_14_MODE << 28)|(P1_13_MODE << 26)|(P1_12_MODE << 24)|
    ...
    zPINMODE3 = (P1_31_MODE << 30)|(P1_30_MODE << 28)|(P1_29_MODE << 26)|(P1_28_MODE << 24)|
    ...
    zPINMODE4 = (P2_15_MODE << 30)|(P2_14_MODE << 28)|(P2_13_MODE << 26)|(P2_12_MODE << 24)|
    ...
    zPINMODE7 = (P3_26_MODE << 20)|(P3_25_MODE << 18);
    
    zPINMODE9 = (P4_29_MODE << 26)|(P4_28_MODE << 24);
#endif

    zFIO0MASK =0x00;                                                     /*  不屏蔽引脚高速功能         */
    zFIO1MASK =0x00;
    zFIO2MASK =0x00;
    zFIO3MASK =0x00;
    zFIO4MASK =0x00;
...
** Parameters:     无
** Return:         无
** Description:    外设功能初始化：1 表示对应外设使能
**                                 0 表示对应外设禁止
**                 
********************************************************************************************************/
void pconpInit (void)
{
    zPCONP = (PCTIM0_FUNC << 1)  | (PCTIM1_FUNC << 2)  | (PCUART0_FUNC << 3) | (PCUART1_FUNC << 4) |
